...
page 50109 "4HC Purchase Invoices API"
{
    APIVersion = 'v2.0';
    ...
    DelayedInsert = true;
    EntityName = 'purchaseInvoice4hc';
    EntitySetName = 'purchaseInvoice4hcs';
    ODataKeyFields = Id;
    PageType = API;
    APIPublisher = 'dragonfly4hc';
    APIGroup = 'damen';
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(approvalStatus; Rec."Email Approval Status")
                {
                ...
                field(approvalRejectReason; Rec."Approval Rejection Reason")
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("Approval Rejection Reason"));
                    end;
                }
    ...
    begin
        ...
        ActionContext.SetObjectId(Page::"4HC Purchase Invoices API");
